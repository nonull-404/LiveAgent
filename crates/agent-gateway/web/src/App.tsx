...
const CHAT_RUNTIME_PREPARING_STATUS = "Preparing request...";
...
function isPreparingChatControlEvent(event: ChatEvent) {
  return (
    isChatControlEvent(event) &&
    (event.state === "queued" ||
...
function isRuntimeStartedChatControlEvent(event: ChatEvent) {
  return (
    isChatControlEvent(event) &&
