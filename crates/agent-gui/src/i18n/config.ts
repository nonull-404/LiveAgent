...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.aboutInstallingDesc": "正在下载并校验更新包，完成后请重启应用。",
    "settings.aboutInstalled": "更新已安装",
    "settings.aboutInstalledDesc": "更新包已安装，重启 LiveAgent 后生效。",
  ...
  "en-US": {
    ...
    "settings.aboutInstallingDesc": "Downloading and verifying the update package. Restart the app after it finishes.",
